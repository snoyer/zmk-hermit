...
def main():
    ...
    parser.add_argument("shield", nargs="?", metavar="SHIELD", help="shield name")
    parser.add_argument("board", metavar="BOARD", help="board name")
    ...
    group.add_argument(
        "--name",
        default="{shield-board}",
        metavar="NAME",
        help="basename used to rename the artefact(s) (default: %(default)s)",
    )
